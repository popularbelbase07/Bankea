...
class ExternalTransferSerializer(serializers.Serializer):
    from_user = serializers.CharField(max_length=128)
    account_pk = serializers.CharField(max_length=128)
    amount = serializers.CharField(max_length=255)
    currency = serializers.CharField(max_length=128)
    credit_text = serializers.CharField(max_length=128)
    
    class Meta:
        fields= ('from_user','account_pk','amount', 'currency', 'credit_text')
