...
class CustomerForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.form_id = 'id-customerForm'
...
class ExternalTransferForm(forms.Form):
    ...
    def clean(self):
        ...
        # Checking if credit account exists in the db
        # external_credit_account = self.cleaned_data.get('external_credit_account')
        # try:
        #     Account.objects.get(pk=external_credit_account)
        # except ObjectDoesNotExist:
        #     self._errors['credit_account'] = self.error_class(['Credit account does not exist.'])
